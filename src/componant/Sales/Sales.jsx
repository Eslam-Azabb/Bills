...
export default class Sales extends Component {
  ...
  test = () => {
    if (JSON.parse(localStorage.getItem("billsList")) != null) {
      Bills = JSON.parse(localStorage.getItem("billsList"));
      this.display()
    }
  }
  display = () => {
    ...
    return (
      <>
        <div className=' '>
          ...
          <div>
            <div id='lightboxContainer' className={style.lightboxContainer}>
