...
import style from '../SalesReturns/SaleReturns.module.css'

var Bills = [];


export default class SalesReturns extends Component {
...
subAction = () => {
  ...
  Bills.push(Bill);
  localStorage.setItem("billsSalesReturnsList", JSON.stringify(Bills))
  
}

test = () => {
  if (JSON.parse(localStorage.getItem("billsSalesReturnsList")) != null) {
    Bills = JSON.parse(localStorage.getItem("billsSalesReturnsList"));
    this.display()
  }
}
display = () => {
  ...
  render() {
    return (
      ...
      <div className=' '>
          ...
          <div className=' container rounded-3 shadow  mb-4 bg-body rounded'>
            <div className='d-flex justify-content-between '>
              <div class="d-flex justify-content-center align-items-center my-2">
                <span className='h4'>SalesReturns</span>
              </div>
        ...
        <div>
          <div id='lightboxContainer' className={style.lightboxContainerSalesReturns}>
