...
import style from '../Purchases/Purchases.module.css'
var Bills = [];
...
export default class Purchases extends Component {
  ...
  subAction = () => {
    ...
    Bills.push(Bill);
    localStorage.setItem("billsPurchasesList", JSON.stringify(Bills))

  }

  test = () => {
    if (JSON.parse(localStorage.getItem("billsPurchasesList")) != null) {
      Bills = JSON.parse(localStorage.getItem("billsPurchasesList"));
      this.display()
    }
  }
  display = () => {
    ...
    return (
      <>
        <div className=' '>
          ...
          <div>
            <div id='lightboxContainer' className={style.lightboxContainerPurchases}>
